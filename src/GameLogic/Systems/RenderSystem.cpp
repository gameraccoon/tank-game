...
//		{
//			backgroundTexture->getSpriteRef().spriteHandle = mResourceManager.lockResource<HAL::Graphics::Sprite>(backgroundTexture->getSpriteDesc().path);
...
//		bgRenderData.uv = HAL::Graphics::QuadUV(uvShift, uvShift + tiles);
//	}
//}
//

...
void DebugDrawSystem::init()
{
	...
	mCollisionSpriteHandle = mResourceManager.lockResource<HAL::Graphics::Sprite>(RelativeResourcePath("resources/textures/protection-field-2.png"));
	mNavmeshSpriteHandle = mResourceManager.lockResource<HAL::Graphics::Sprite>(RelativeResourcePath("resources/textures/explosive-small-2.png"));
	mPointTextureHandle = mResourceManager.lockResource<HAL::Graphics::Sprite>(RelativeResourcePath("resources/textures/protection-field-2.png"));
	mLineTextureHandle = mResourceManager.lockResource<HAL::Graphics::Sprite>(RelativeResourcePath("resources/textures/explosive-small-2.png"));
	mArrowUpTextureHandle = mResourceManager.lockResource<HAL::Graphics::Sprite>(RelativeResourcePath("resources/textures/debug/arrow-up.png"));
	mArrowDownTextureHandle = mResourceManager.lockResource<HAL::Graphics::Sprite>(RelativeResourcePath("resources/textures/debug/arrow-down.png"));
	mArrowLeftTextureHandle = mResourceManager.lockResource<HAL::Graphics::Sprite>(RelativeResourcePath("resources/textures/debug/arrow-left.png"));
	mArrowRightTextureHandle = mResourceManager.lockResource<HAL::Graphics::Sprite>(RelativeResourcePath("resources/textures/debug/arrow-right.png"));

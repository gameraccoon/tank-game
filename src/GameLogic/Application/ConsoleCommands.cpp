...
namespace ConsoleCommands
{
	...
	bool TryExecuteQuickConsoleCommands(const ArgumentsParser& arguments)
	{
		const std::vector<CommandInfo> commands{
			...
			{ "pretend-connected", "pretend-connected", "make the fake network pretend to be connected to the server" },
			{ "set-replay-instance", "set-replay-instance <id>", "force replaying as a specific client from a mulplayer recording" },
